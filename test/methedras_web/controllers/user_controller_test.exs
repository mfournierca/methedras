defmodule MethedrasWeb.UserControllerTest do
  use MethedrasWeb.ConnCase

  alias Methedras.Catalog

  @create_attrs %{email: "some email", realm: "some realm", username: "some username"}
  ...
  def fixture(:user) do
    {:ok, user} = Catalog.create_user(@create_attrs)
    user
  end
