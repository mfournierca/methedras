defmodule MethedrasWeb.ChecklistControllerTest do
  ...
  describe "new checklist" do
    test "renders form", %{conn: conn} do
      conn = get conn, checklist_path(conn, :new)
  ...
  describe "create checklist" do
    test "redirects to show when data is valid", %{conn: conn} do
      ...
      assert redirected_to(conn) == checklist_path(conn, :show, id)
  ...
  describe "edit checklist" do
    ...
    test "renders form for editing chosen checklist", %{conn: conn, checklist: checklist} do
      conn = get conn, checklist_path(conn, :edit, checklist)
  ...
  describe "update checklist" do
    ...
    test "redirects when data is valid", %{conn: conn, checklist: checklist} do
      ...
      assert redirected_to(conn) == checklist_path(conn, :show, checklist)

      conn = get conn, checklist_path(conn, :show, checklist)
  ...
  describe "delete checklist" do
    ...
    test "deletes chosen checklist", %{conn: conn, checklist: checklist} do
      ...
      assert redirected_to(conn) == checklist_path(conn, :index)
